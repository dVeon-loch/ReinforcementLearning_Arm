...
# Opening SAC logfile that contains all SAC data (was manually copied and pasted in from the various runs)

# SAClogfile = open('results/SACslow/20201111T005349.830047_SAC_/20201111T005349.907611.log','r')
SAClogfile = open('results/SAC_staticslow/20201110T180447.910284_SAC_/20201110T180447.996016.log','r')
pattern = '.*Total Epi\:%{SPACE}%{BASE10NUM:episode_num} .*%{BASE10NUM:total_steps}.*Return\:%{SPACE}%{BASE10NUM:episode_return}.*'

# Using grok to extract the needed datafields
...
# Filtering raw data with Savitzky-Golay filter because training data is typically very noisy
...
# PPO was trained for much longer which is why this was done, change this if necessary
...
plt.figure()
plt.title('Static Goal Training Return')
